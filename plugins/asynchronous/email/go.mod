...
require (
	github.com/dvonthenen/enterprise-conversation-application v0.1.10-0.20230518174922-57dadf2e5068 // indirect
	github.com/dvonthenen/rabbitmq-manager v0.1.1 // indirect
	github.com/dvonthenen/symbl-go-sdk v0.1.8 // indirect
