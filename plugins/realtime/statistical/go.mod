module github.com/dvonthenen/enterprise-conversation-plugins/plugins/realtime/statistical

go 1.18

require (
	github.com/dvonthenen/enterprise-conversation-application v0.1.10
